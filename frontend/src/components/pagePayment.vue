                    ...
                    <form class="form-card">
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex"> <label
                                    ...
                                    type="text" placeholder=""> </div>
                            <div class="form-group col-sm-6 flex-column d-flex"> <label
                                    class="form-control-label px-3">Numero telefonico<span class="text-danger">
                            ...
                            <form>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div class="form-outline">
                                        <label class="form-label" for="typeText">Numero di carta<span class="text-danger">
                                                *</span></label>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <div class="form-outline">
                                        <label class="form-label" for="typeName">Nome del titolare<span class="text-danger">
                                                *</span></label>
                                ...
                                <div class="d-flex justify-content-between align-items-center pb-2">
                                    <div class="form-outline">
                                        <label class="form-label" for="typeExp">Expiration<span class="text-danger">
                                                *</span></label>
                                        <input type="text" id="typeExp" class="form-control form-control-lg"
                                            placeholder="MM/YY" size="7" minlength="7" maxlength="7" />
                                    </div>
                                    <div class="form-outline">
                                        <label class="form-label" for="typeText2">Cvv<span class="text-danger">
                                                *</span></label>
