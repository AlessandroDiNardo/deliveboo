...
<section class="py-5">
    <div class="ms_product_cont">
        ...
        <div class="d-flex justify-content-start align-items-center flex-wrap product_cont">
            @foreach ( $restaurant -> products as $product)
            <div class="card-deck d-flex justify-content-start align-items-centerga p-3 flex-wrap" >
                <div class="card " style="height:600px; width:400px;">
                    <img src="{{ str_contains($product -> img, 'http') ? $product -> img : asset('storage/' . $product -> img) }}" alt="Card image cap" class=" card-img-top" style="height:300px; width:398px;">
